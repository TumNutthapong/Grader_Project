      ...
      <div class="col-md-5 mb-4">
        <div class="card border-dark mt-2">
          ...
          <div class="card-body">
            ...
            <h5 class="card-text">หมู่เรียน : <span class="badge bg-primary"><?php echo $result[5]; ?></span></h5>
            <h5 class="card-text">รหัสนิสิต : <span class="badge bg-primary"><?php echo $result[6]; ?></span> </h5>
            <h5 class="card-text">ระดับผู้ใช้ : <span class="badge bg-primary"><?php if ($result[7] == "student") {echo "นักเรียน";}else{echo "อาจารย์";} ?></span></h5>
            <div class="mt-3">
