          ...
          <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-lg-end">
              ...
              if ($_SESSION["user_level"] == "student") {
                ?>
                <li><button class="dropdown-item" type="button" onclick="window.location.href='sub_record.php?user_id=<?php echo $result_tb_user['user_id'] ?>'">ประวัติการส่งงาน</button></li>
              ...
              if ($_SESSION["user_level"] == "teacher") {
                ?>
                <li><button class="dropdown-item" type="button" onclick="window.location.href='teacher/ex.php'">ระบบหลังบ้าน</button></li>
                <?php
              }
              ?>
              <hr>
