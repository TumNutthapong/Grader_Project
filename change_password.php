...
if (isset($_POST['save'])) {
  if ($_POST['password_old'] != $result[1]) {
    ...
    $check_submit = '<div class="alert alert-danger" role="alert">';
    $check_submit .= '<span><i class="bi bi-info-circle"></i> รหัสผ่านใหม่ ไม่ตรงกัน ยืนยันรหัสผ่านใหม่</span>';
    $check_submit .= '</div>';
  }else{
    $sql_2 = "UPDATE tb_user SET user_password = '".$_POST["password_new"]."' WHERE user_username = '".$_SESSION['user_username']."'";
          ...
          <div class="card-body">
            <div class="row justify-content-md-center mb-2">
              <div class="col col-lg-6">
                <img src="images/pass.png" style="width: 100%;">
              </div>
            </div>
            <form method="post">
              <div class="mb-3">
