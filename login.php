...
if (isset($_POST["submit"])) {
  $sql = "SELECT * FROM tb_user WHERE user_username = '".mysqli_real_escape_string($Connection,$_POST['user_username'])."' and user_password = '".mysqli_real_escape_string($Connection,($_POST['user_password']))."'";
  ...
  if (!$result) {
    ...
    if ($_SESSION["user_level"] == 'teacher') {
      header("location:teacher/add_sub.php");
      exit();
    }else{
      header("location:index.php");
      exit();
          ...
          <div class="card-body">
            <div class="row justify-content-md-center mb-2">
              <div class="col col-lg-6">
                <img src="images/ku-logo.jpg" style="width: 100%;">
              </div>
            </div>
            <form method="post">
              <div class="mb-3">
